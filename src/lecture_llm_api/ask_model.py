...
if __name__ == "__main__":
    ...
    # для задачи обязателclьно использовать rich console https://rich.readthedocs.io/en/latest/console.html
